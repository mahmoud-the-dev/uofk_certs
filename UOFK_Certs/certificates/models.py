...
STATUSES = (('wfp','waiting for payment'),('ip','in_process'),('rd','ready'),('rcv','received'))
...
class CertificateRequest(models.Model):
    ...
    student = models.ForeignKey(Student,on_delete=models.CASCADE)# ForeignKey
    request_status = models.CharField(max_length=55, choices=STATUSES, default=('wfp','waiting for payment'))
...
class CertificateItem(models.Model):
    ...
    status = models.CharField(max_length=55, choices=STATUSES, default=('wfp','waiting for payment'))
